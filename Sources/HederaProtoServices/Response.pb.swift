...
public struct Proto_Response {
  ...
  public var tokenGetAccountNftInfo: Proto_TokenGetAccountNftInfoResponse {
    get {
      if case .tokenGetAccountNftInfo(let v)? = response {return v}
      return Proto_TokenGetAccountNftInfoResponse()
    }
    set {response = .tokenGetAccountNftInfo(newValue)}
  }
  ...
  public enum OneOf_Response: Equatable {
    ...
    /// A list of the NFTs associated with the account
    case tokenGetAccountNftInfo(Proto_TokenGetAccountNftInfoResponse)
    /// All information about an NFT
    ...
    public static func ==(lhs: Proto_Response.OneOf_Response, rhs: Proto_Response.OneOf_Response) -> Bool {
      ...
      case (.tokenGetAccountNftInfo, .tokenGetAccountNftInfo): return {
        guard case .tokenGetAccountNftInfo(let l) = lhs, case .tokenGetAccountNftInfo(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
extension Proto_Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    154: .same(proto: "tokenGetAccountNftInfo"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 154: try {
        var v: Proto_TokenGetAccountNftInfoResponse?
        var hadOneofValue = false
        if let current = self.response {
          hadOneofValue = true
          if case .tokenGetAccountNftInfo(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.response = .tokenGetAccountNftInfo(v)
        }
      }()
      case 155: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .tokenGetAccountNftInfo?: try {
      guard case .tokenGetAccountNftInfo(let v)? = self.response else { preconditionFailure() }
