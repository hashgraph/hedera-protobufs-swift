...
public struct Proto_Query {
  ...
  public var tokenGetAccountNftInfo: Proto_TokenGetAccountNftInfoQuery {
    get {
      if case .tokenGetAccountNftInfo(let v)? = query {return v}
      return Proto_TokenGetAccountNftInfoQuery()
    }
    set {query = .tokenGetAccountNftInfo(newValue)}
  }
  ...
  public enum OneOf_Query: Equatable {
    ...
    /// Get a list of NFTs associated with the account
    case tokenGetAccountNftInfo(Proto_TokenGetAccountNftInfoQuery)
    /// Get all information about a NFT
...
extension Proto_Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    54: .same(proto: "tokenGetAccountNftInfo"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 54: try {
        var v: Proto_TokenGetAccountNftInfoQuery?
        var hadOneofValue = false
        if let current = self.query {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.query = .tokenGetAccountNftInfo(v)
        }
      }()
      case 55: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .tokenGetAccountNftInfo?: try {
      guard case .tokenGetAccountNftInfo(let v)? = self.query else { preconditionFailure() }
