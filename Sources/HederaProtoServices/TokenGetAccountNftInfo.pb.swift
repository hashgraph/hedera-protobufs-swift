...
public struct Proto_TokenGetAccountNftInfoQuery {
...
public struct Proto_TokenGetAccountNftInfoResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Proto_TokenGetAccountNftInfoQuery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TokenGetAccountNftInfoQuery"
  ...
  public static func ==(lhs: Proto_TokenGetAccountNftInfoQuery, rhs: Proto_TokenGetAccountNftInfoQuery) -> Bool {
...
extension Proto_TokenGetAccountNftInfoResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TokenGetAccountNftInfoResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "header"),
    2: .same(proto: "nfts"),
  ]
  ...
  public static func ==(lhs: Proto_TokenGetAccountNftInfoResponse, rhs: Proto_TokenGetAccountNftInfoResponse) -> Bool {
    if lhs._header != rhs._header {return false}
